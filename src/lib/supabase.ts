...
// Production Supabase project selected in the Authentication > Sign In / Providers
// configuration supplied for Testagram. Keep the project URL aligned with the
// Google OAuth callback configured in Supabase.
