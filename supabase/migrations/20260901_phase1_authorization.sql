...
-- Client applications use authenticated Edge Functions for financial mutations.
...
-- Fee configuration remains service-role/admin managed; no client policy is granted.
