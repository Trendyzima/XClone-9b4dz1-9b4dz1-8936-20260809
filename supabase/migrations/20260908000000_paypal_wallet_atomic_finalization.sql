...
revoke all on function public.ensure_wallet(uuid) from public; grant execute on function public.ensure_wallet(uuid) to authenticated,service_role;
revoke all on function public.finalize_paypal_topup(text,text) from public,anon,authenticated; grant execute on function public.finalize_paypal_topup(text,text) to service_role;
