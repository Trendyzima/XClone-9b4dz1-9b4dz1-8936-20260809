...
as $$
declare
  origin constant text = 'https://testagram-api.nahashonnyaga794.workers.dev';
  canonical text;
begin
...
set actor_url = 'https://testagram-api.nahashonnyaga794.workers.dev/users/' || regexp_replace(lower(username), '[^a-z0-9_-]', '_', 'g'),
    inbox_url = 'https://testagram-api.nahashonnyaga794.workers.dev/users/' || regexp_replace(lower(username), '[^a-z0-9_-]', '_', 'g') || '/inbox';
